class EstudiantesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @estudiante.save
        format.html { redirect_to @estudiante, notice: 'Estudiante creado con éxito.' }
  ...
  def update
    respond_to do |format|
      if @estudiante.update(estudiante_params)
        format.html { redirect_to @estudiante, notice: 'Estudiante actualizado con éxito.' }
  ...
  def destroy
    @estudiante.destroy
    respond_to do |format|
      format.html { redirect_to estudiantes_url, notice: 'Estudiante eliminado con éxito.' }
  ...
  private
    ...
    def estudiante_params
      params.require(:estudiante).permit(:nombre, :matricula, :correo, :telefono, :persona_id, :carrera_id)
    end
end
