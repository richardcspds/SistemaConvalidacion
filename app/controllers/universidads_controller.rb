class UniversidadsController < ApplicationController
  ...
  def index
    @search = Universidad.search(params[:q])
    @universidads = @search.result
  end
  ...
  def create
    ...
    respond_to do |format|
      if @universidad.save
        format.html { redirect_to @universidad, notice: 'Universidad creada con éxito.' }
  ...
  def update
    respond_to do |format|
      if @universidad.update(universidad_params)
        format.html { redirect_to @universidad, notice: 'Universidad editada con éxito.' }
  ...
  def destroy
    @universidad.destroy
    respond_to do |format|
      format.html { redirect_to universidads_url, notice: 'Universidad eliminada con éxito.' }
  ...
  private
    ...
    def universidad_params
      params.require(:universidad).permit(:nombre, :descripcion, :logo)
    end
end
