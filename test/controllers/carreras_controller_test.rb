...
class CarrerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post carreras_url, params: { carrera: { nombre: @carrera.nombre, universidad_id: @carrera.universidad_id } }
    end
  ...
  test "should update carrera" do
    patch carrera_url(@carrera), params: { carrera: { nombre: @carrera.nombre, universidad_id: @carrera.universidad_id } }
