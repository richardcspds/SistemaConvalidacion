...
class PersonasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post personas_url, params: { persona: { descripcion: @persona.descripcion, tipo: @persona.tipo } }
    end
  ...
  test "should update persona" do
    patch persona_url(@persona), params: { persona: { descripcion: @persona.descripcion, tipo: @persona.tipo } }
