...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { carrera_id: @estudiante.carrera_id, correo: @estudiante.correo, matricula: @estudiante.matricula, nombre: @estudiante.nombre, persona_id: @estudiante.persona_id, telefono: @estudiante.telefono } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { carrera_id: @estudiante.carrera_id, correo: @estudiante.correo, matricula: @estudiante.matricula, nombre: @estudiante.nombre, persona_id: @estudiante.persona_id, telefono: @estudiante.telefono } }
