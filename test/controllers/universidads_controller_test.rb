...
class UniversidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universidad" do
    assert_difference('Universidad.count') do
      post universidads_url, params: { universidad: { descripcion: @universidad.descripcion, logo: @universidad.logo, nombre: @universidad.nombre } }
    end
  ...
  test "should update universidad" do
    patch universidad_url(@universidad), params: { universidad: { descripcion: @universidad.descripcion, logo: @universidad.logo, nombre: @universidad.nombre } }
