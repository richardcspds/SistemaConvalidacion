...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { creditos: @asignatura.creditos, nombre: @asignatura.nombre, pensum_id: @asignatura.pensum_id } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { creditos: @asignatura.creditos, nombre: @asignatura.nombre, pensum_id: @asignatura.pensum_id } }
